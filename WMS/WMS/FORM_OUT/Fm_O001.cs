...
namespace WMS
{
    public partial class Fm_O001 : Form
    {
        // 多國語言資源檔設定
        ...
        private void Fm_O001_Load(object sender, EventArgs e)
        {
        ...
        private void RefreshData(DateTime? Sdate, DateTime? Edate, vPublic.StatusCtr? _StatusCtr)
        {
            ...
            List<Model.WmsOutLine> OutLists = new List<Model.WmsOutLine>();
            var result = ListService.GetAllWmsOutLine(Sdate, Edate, _StatusCtr, ref OutLists);
            ...
            gdc_WMS_OUT_LINE.DataSource = OutLists;
        }
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            {
                gdv_WMS_OUT_LINE.ExportToXlsx(sfd.FileName);
            }
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            gdc_WMS_OUT_LINE.ShowPrintPreview();
        ...
        {
            Fm_O001_1 objForm = new Fm_O001_1();
            objForm.ShowDialog();
        ...
        {
            string LIST_NO = gdv_WMS_OUT_LINE.GetFocusedRowCellValue("LIST_NO").ToString();
            int LINE_ID = Convert.ToInt16(gdv_WMS_OUT_LINE.GetFocusedRowCellValue("LINE_ID"));

            List<Model.WmsOutLine> Data = new List<WMS.Model.WmsOutLine>();
            var result = ListService.GetWmsOutLineByListNoAndID(LIST_NO, LINE_ID, ref Data);
            if (result.Successed == false)
            {
                vPublic.ShowAlert(Fm_Alert.AlertType.Error, result.Message);
                return;
            ...
            //刪除單據資料
            result = ListService.DeleteWmsOutList(Data);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            EditModel.ORG_NO = cmbOrgNo.EditValue.ToString();
            ...
            result = ListService.EditWmsOutList(Data);
            vPublic.ShowAlert(result.Successed == false ? Fm_Alert.AlertType.Error : Fm_Alert.AlertType.Successful
                              , result.Message);
            if (result.Successed)
            {
        ...
        private void repositoryItemButtonEdit_Complete_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            result = ListService.CompleteWmsOutList(Data);
            vPublic.ShowAlert(result.Successed == false ? Fm_Alert.AlertType.Error : Fm_Alert.AlertType.Successful
                              , result.Message);
            if (result.Successed)
            {
