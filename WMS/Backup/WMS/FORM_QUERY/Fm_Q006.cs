...
namespace WMS
{
    public partial class Fm_Q006 : Form
    {
        System.Resources.ResourceManager RM = new System.Resources.ResourceManager(string.Format("WMS.Language.{0}.Resource_Fm_Q006", "FORM_QUERY"), System.Reflection.Assembly.GetExecutingAssembly());
        public Fm_Q006()
        {
            InitializeComponent();
        }

        private void Fm_Q006_Load(object sender, EventArgs e)
        {
            ...
            spinEdit_Days.StyleController = Program.STYLER;
        ...
        private void RefreshData(string SearchText)
        {
            ...
            Data = Data.Where(o => o.STOREIN_DATE <= DateTime.Now.AddDays(-(double)spinEdit_Days.Value)).ToList();
