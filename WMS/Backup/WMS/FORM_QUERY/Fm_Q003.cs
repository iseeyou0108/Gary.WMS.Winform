...
namespace WMS
{
    public partial class Fm_Q003 : Form
    {
        System.Resources.ResourceManager RM = new System.Resources.ResourceManager(string.Format("WMS.Language.{0}.Resource_Fm_Q003", "FORM_QUERY"), System.Reflection.Assembly.GetExecutingAssembly());
        public Fm_Q003()
        {
            InitializeComponent();
        }

        private void Fm_Q003_Load(object sender, EventArgs e)
        {
        ...
        private void RefreshData(string SearchText)
        {
            ...
            var result = StkLib.GetSummaryWmsStk(Convert.ToInt16(cmbAsrsID.EditValue), ref Data);
