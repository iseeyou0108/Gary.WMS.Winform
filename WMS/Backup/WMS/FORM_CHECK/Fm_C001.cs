...
namespace WMS
{
    public partial class Fm_C001 : Form
    {
        System.Resources.ResourceManager RM = new System.Resources.ResourceManager(string.Format("WMS.Language.{0}.Resource_Fm_C001", "FORM_CHECK"), System.Reflection.Assembly.GetExecutingAssembly());
        ...
        private void Fm_C001_Load(object sender, EventArgs e)
        {
        ...
        void RefreshData()
        {
            ...
            //盤點僅盤在庫/待驗庫存
            Stks = Stks.Where(o => o.STUS_CTR == Convert.ToDecimal(Model.WmsStk.StusCtr.可用庫存) ||
                o.STUS_CTR == Convert.ToDecimal(Model.WmsStk.StusCtr.待驗庫存)).ToList();
